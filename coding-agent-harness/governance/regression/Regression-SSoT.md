...
| RG-005 | Obsidian Base 与收件箱结构 | YAML parse + Obsidian 1.12.7 人工打开 + inbox normalizer tests | Base/字段/目录变更 | L1-tests | 2026-07-14 | pass-with-residual | user + coordinator | R-005 |
| RG-006 | 微信抓取与定时任务 | 3 个试验源 + `17 */2 * * *` | 授权、抓取配置、镜像升级 | L3-live | 2026-07-14 | partial（授权/任务/12源有文章，长期周期待观察） | user | R-006 |
| RG-007 | Folo 云端刷新稳定性 | `scripts/record-observation.sh` + Folo UI | Feed/订阅/Folo 变更 | L3-live | 2026-07-14 | paused | user | R-007 |
| RG-008 | Folo -> Obsidian 五类样本与同名保护 | Folo UI + Vault 样本检查 + normalizer tests | Folo/Obsidian 集成变更 | L3-live | 2026-07-14 | partial（整理器/不覆盖已测，真实导出待登录） | user | R-008 |
...
| R-005 | RG-005 | Base 与日期批注整理器已静态/单测验证，尚未在 Obsidian UI 用真实导出确认列类型/显示 | P2 | user | 2026-07-14 | 打开 `公众号精选.base` 并检查首个真实样本 | open |
| R-006 | RG-006 | 授权、12 个源和 Cron 已完成；补抓已使 12/12 个源入库；至少 36 个自动周期仍待观察 | P1 | user | 2026-07-14 | WeRSS UI、任务队列与 Atom | open |
| R-007 | RG-007 | 72 小时/7 天 Folo 观察尚未开始 | P1 | user | 2026-07-14 | `docs/稳定性观察模板.md` | open |
| R-008 | RG-008 | 日期命名、同页批注布局、幂等与同名不覆盖已自动化并通过 3 个测试；Basic、集成授权与五类真实导出样本尚未完成 | P1 | user | 2026-07-14 | 登录/Funnel/72 小时门禁后执行 | open |
