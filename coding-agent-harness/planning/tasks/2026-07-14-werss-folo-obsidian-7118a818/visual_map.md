...
| WERSS-01 | execution | INIT-01 | in_progress | 92 | 12 源、105 篇、每小时 Cron | SQLite、任务队列、72h/7d | n/a | coordinator | partial | 时间证据 | user + coordinator |
| READECK-01 | execution | WERSS-01 | done | 100 | 101 loaded、aarch64、中文阅读 UI | API/SQLite/UI | n/a | agent | present | none | coordinator |
| OBSIDIAN-01 | execution | READECK-01 | done | 100 | 收藏/高亮/批注/不覆盖/Base | 真实笔记、hash、UI screenshot、Base | n/a | agent | present | none | coordinator |
| CLOUDFLARE-01 | gate | OBSIDIAN-01 | done | 100 | Access、Tunnel、DNS、免 Readeck 密码 | 403/Access OTP/Tunnel/DNS/公网 smoke | n/a | coordinator | present | none | user + coordinator |
